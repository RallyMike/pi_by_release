...
Ext.define('CustomApp', {
    ...
    gPiObjectID: undefined,             // PI object ID to breakdown upon initial load from preferences
    ...
    launch:function () {
        ...
        // add App controls to page
        this._addAppControls();


        // check if a PI was already set in preferences
        if (this.gPiObjectID !== null && this.gPiObjectID > 0){
    ...
    // add the App's controls to the page
    ...
    _getLeafStoriesInPi:function () {
        ...
        piTextBox.update('<font size="5"><br><b>Portfolio Item: </b>' + this.gPiFormattedID + " - " + this.gPiName + "</font>");
    ...
    _processAppPrefs:function () {
        ...
        // NOTE: preferences returns strings
        // ...convert to integers where needed (LBAPI requires integers)
